...
export const matchApi = {
  ...
  confirm: (id, payload) =>
    api(`/matches/${id}/confirmations`, {
      method: "POST",
      body: JSON.stringify(payload),
    }),
  deposit: (id, payload) =>
    api(`/matches/${id}/deposits`, {
      method: "POST",
      body: JSON.stringify(payload),
    }),
  result: (id, payload) =>
...
export const profileApi = {
  update: (payload) =>
    api("/profile", { method: "PATCH", body: JSON.stringify(payload) }),
};
...
export const paymentApi = {
  createMatchDepositCheckout: (payload) =>
    api("/payments/match-deposits/checkout", {
      method: "POST",
      body: JSON.stringify(payload),
    }),
  syncMatchDeposit: (id) =>
    api(`/payments/match-deposits/${id}/sync`, { method: "POST" }),
};
